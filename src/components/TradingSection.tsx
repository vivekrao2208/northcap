        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="mt-8"
            >
              <button className="bg-gray-900 text-white px-8 py-3 rounded-lg hover:bg-gray-800 transition-colors duration-200 font-semibold">
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute -bottom-6 -left-6 bg-white rounded-lg shadow-lg p-6 border border-gray-100"
            >
